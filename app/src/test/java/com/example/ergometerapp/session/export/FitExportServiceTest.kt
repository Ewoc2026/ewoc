...
class FitExportServiceTest {
    ...
    fun buildFitBytes_writesLapAndSessionSummariesWithFitProfileFieldNumbers() {
        ...
        assertField(lapFields, fieldNumber = 15, baseType = 0x02, value = 107)
        assertField(lapFields, fieldNumber = 16, baseType = 0x02, value = 112)
        assertField(lapFields, fieldNumber = 17, baseType = 0x02, value = 82)
        assertField(lapFields, fieldNumber = 18, baseType = 0x02, value = 84)
        assertField(lapFields, fieldNumber = 19, baseType = 0x84, value = 124)
        assertField(lapFields, fieldNumber = 20, baseType = 0x84, value = 128)

        val sessionFields = parseFirstDataFieldDetails(bytes, globalMessageNumber = 18)
        assertField(sessionFields, fieldNumber = 16, baseType = 0x02, value = 107)
        assertField(sessionFields, fieldNumber = 17, baseType = 0x02, value = 112)
        assertField(sessionFields, fieldNumber = 18, baseType = 0x02, value = 82)
        assertField(sessionFields, fieldNumber = 19, baseType = 0x02, value = 84)
        assertField(sessionFields, fieldNumber = 20, baseType = 0x84, value = 124)
        assertField(sessionFields, fieldNumber = 21, baseType = 0x84, value = 128)
