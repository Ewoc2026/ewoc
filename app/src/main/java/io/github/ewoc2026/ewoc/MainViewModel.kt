...
import io.github.ewoc2026.ewoc.ai.AiPolicyGuardrails
import io.github.ewoc2026.ewoc.ai.AiPresentationAdapter
import io.github.ewoc2026.ewoc.ai.AiPresentedMessageRecord
import io.github.ewoc2026.ewoc.ai.AiRecentEmission
import io.github.ewoc2026.ewoc.ai.AiRecommendationEngine
import io.github.ewoc2026.ewoc.ai.AiRecommendationType
import io.github.ewoc2026.ewoc.ai.AiRuleConfig
import io.github.ewoc2026.ewoc.ai.AiTelemetryLogger
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestActiveFtpStatePort
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestCoordinator
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestLiveMetricsSnapshot
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestResult
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestResultPromotionCoordinator
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestRuntimePort
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestRuntimeSnapshot
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestSettingsStorage
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestTrainerPreparationState
import io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestTrainerControlRequestOutcome
import io.github.ewoc2026.ewoc.ble.BleDeviceScanner
import io.github.ewoc2026.ewoc.ble.HrBleClient
import io.github.ewoc2026.ewoc.compat.CompatibilityCheckOrchestrator
...
import io.github.ewoc2026.ewoc.compat.CompatibilityRunArtifactsStorage
import io.github.ewoc2026.ewoc.compat.FtmsCompatibilityDeviceGateway
import io.github.ewoc2026.ewoc.compat.quirks.QuirksRegistry
import io.github.ewoc2026.ewoc.logging.AppLog
import io.github.ewoc2026.ewoc.session.MockTrainerDebugScenario
import io.github.ewoc2026.ewoc.session.ExternalTrainerControlRequestOutcome
import io.github.ewoc2026.ewoc.session.ExternalTrainerPreparationState
import io.github.ewoc2026.ewoc.session.SessionManager
import io.github.ewoc2026.ewoc.session.SessionOrchestrator
...
import io.github.ewoc2026.ewoc.session.export.FitExportService
import io.github.ewoc2026.ewoc.session.export.SessionExportSnapshot
import io.github.ewoc2026.ewoc.ewoeditor.EwoEditorCoordinator
import io.github.ewoc2026.ewoc.ui.EwoEditorScreenAction
import io.github.ewoc2026.ewoc.ui.MenuSetupStep
import io.github.ewoc2026.ewoc.workout.BundledWorkoutAssetCatalog
import io.github.ewoc2026.ewoc.workout.StarterWorkoutProvider
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun finalizePreparedWorkoutCompletionForContinuation():
        io.github.ewoc2026.ewoc.session.SessionSummary? {
        sessionManager.armContinuationCheckpoint()
    ...
    private val ewoEditorOpenStatePort = object : EwoEditorOpenStatePort {
        ...
        override fun openLegacyWorkout(
            workoutFile: io.github.ewoc2026.ewoc.workout.WorkoutFile,
            fileName: String,
        ) {
    ...
    private fun syncBaselineFitnessTestTicking() {
        val requiresTicking = when (baselineFitnessTestRuntimeSnapshotState.value.phase) {
            io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestUiPhase.PRECHECK,
            io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestUiPhase.REQUESTING_CONTROL,
            io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestUiPhase.WARMUP,
            io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestUiPhase.RAMP_ACTIVE,
            io.github.ewoc2026.ewoc.baseline.BaselineFitnessTestUiPhase.COOLDOWN -> true
     ...
     */
    private fun autoExportFingerprint(summary: io.github.ewoc2026.ewoc.session.SessionSummary): String {
        return listOf(
