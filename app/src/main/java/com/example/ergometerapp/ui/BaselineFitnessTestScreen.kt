...
import com.example.ergometerapp.baseline.BaselineFitnessTestConfidence
...
import com.example.ergometerapp.baseline.BaselineFitnessTestStopReason
import com.example.ergometerapp.baseline.BaselineFitnessTestUiPhase
import com.example.ergometerapp.baseline.BaselineFitnessZoneCalculator
...
private fun BaselineActiveContent(
    ...
    val controlModeLabel = when (snapshot.controlMode) {
        com.example.ergometerapp.baseline.BaselineFitnessTestControlMode.ERG ->
            stringResource(R.string.baseline_fitness_test_label_control_mode_erg)
        com.example.ergometerapp.baseline.BaselineFitnessTestControlMode.ADVISORY ->
