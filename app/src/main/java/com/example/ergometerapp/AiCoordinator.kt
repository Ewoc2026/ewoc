...
import com.example.ergometerapp.ai.AiLiveMetrics
...
import com.example.ergometerapp.ai.AiSignalMeta
import com.example.ergometerapp.ai.AiWearableNormalizationResult
import com.example.ergometerapp.ai.AiWorkoutContext
import com.example.ergometerapp.ai.shouldSuppressInRideCadenceCue
import com.example.ergometerapp.ai.AiConnectivityQuality
import com.example.ergometerapp.ai.AiContext
...
internal class AiCoordinator(
    ...
    private fun calculateCompletionRatio(
        plannedTss: Double?,
        summary: com.example.ergometerapp.session.SessionSummary?,
    ): Double? {
